...
beyaz = 255, 255, 255
kirmizi = 255, 0, 0
ekran = pygame.display.set_mode(resolution, screen_mode)
...
def olustur():
    ...
    ekran.blit(oyuncuyazi1, ((resolution[0] - 35) / 2, 145))
    ekran.blit(oyuncuyazi2, ((resolution[0] - 35) / 2, 60))
    ekran.blit(bilgi_yazi, ((resolution[0] - bx) / 2, boy * 4 + 8))
    ekran.blit(bilgi_yazi2, ((resolution[0] - bx2) / 2, boy * 4 + by + 16))
...
def fonkoyunbitti():
    ...
    bittiyazi2 = font2.render(
        "1. Oyuncu: " + str(s[13]) + " 2. Oyuncu: " + str(s[6]), 1, mavi
    )
    x2, y2 = bittiyazi2.get_size()
    bittiyazi3 = font2.render("Y: Yeni Oyun ESC: Cikis", 1, beyaz)
    x3, y3 = bittiyazi3.get_size()
    ekran.blit(bittiyazi1, ((resolution[0] - x1) / 2, (resolution[1] - y2) / 2 - y1))
    ekran.blit(bittiyazi2, ((resolution[0] - x2) / 2, (resolution[1] - y2) / 2))
    ekran.blit(bittiyazi3, ((resolution[0] - x3) / 2, (resolution[1] - y2) / 2 + y2))
